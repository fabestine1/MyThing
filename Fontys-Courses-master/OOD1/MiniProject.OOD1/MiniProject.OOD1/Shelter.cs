...
namespace AnimalShelter
{
    public class Shelter
    {
        ...
        /// <returns>List of adoptable animals</returns>
        public List<Animal> GetAdoptableAnimalsForOwner(int ownerID)
        {
            List<Animal> temp = new List<Animal>();
            foreach(Animal a in animalList)
            {
        ...
        /// <summary>
        /// Returns not-yet-adoptable animals 
        /// </summary>
        /// <returns>List of not-yet-adoptable animals</returns>
        public List<Animal> GetNotYetAdoptableAnimals()
        {
            List<Animal> temp = new List<Animal>();
            foreach (Animal a in animalList)
            {
